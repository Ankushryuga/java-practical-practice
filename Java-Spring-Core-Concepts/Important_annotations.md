...
# Example:
  ...
  - 8. **@Service**: Services encapsulates the business logic of your application and are responsible for performing specific tasks and coordinating actions b/w different components.
# Example: 
      @Service
